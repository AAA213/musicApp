	...
	<section class="aui-scrollView">
		...
		<div class="aui-chang-list">
			<div class="aui-user-img">
				<img style="width:100%;height:100%" :src="$store.state.user.userDetail.profile.avatarUrl" alt="">
			</div>
			<div class="aui-user-text">
				<h1>{{$store.state.user.userDetail.profile.nickname}}</h1>
				<span v-if="$store.state.user.userDetail.profile.vipType == 0"><i class="icon icon-vip"></i>您还未开通VIP
                <br>
                <button>开通会员</button>
                </span>
                <span v-else><i class="icon icon-vip"></i>VIP</span>
		...
		<div class="aui-palace aui-palace-one">
			<a href="javascript:;" class="aui-palace-grid">
				<div class="aui-palace-grid-icon">
					<img src="../assets/imgs/nav-001.png" alt="">
				</div>
			...
			<a href="javascript:;" class="aui-palace-grid">
				<div class="aui-palace-grid-icon">
					<img src="../assets/imgs/nav-002.png" alt="">
				</div>
				<div class="aui-palace-grid-text">
					<h2>客户管理</h2>
				</div>
			...
			<a href="javascript:;" class="aui-palace-grid">
				<div class="aui-palace-grid-icon">
					<img src="../assets/imgs/nav-003.png" alt="">
				</div>
				<div class="aui-palace-grid-text">
					<h2>任务监控</h2>
				</div>
			...
			<a href="javascript:;" class="aui-palace-grid">
				<div class="aui-palace-grid-icon">
					<img src="../assets/imgs/nav-004.png" alt="">
				</div>
				<div class="aui-palace-grid-text">
					<h2>数据统计</h2>
				</div>
		...
		<div class="aui-list-item">
			<a href="javascript:;" class="aui-flex b-line">
				<div class="aui-cou-img">
					<img src="../assets/imgs/icon-001.png" alt="">
				</div>
			...
			<a href="javascript:;" class="aui-flex b-line">
				<div class="aui-cou-img">
					<img src="../assets/imgs/icon-002.png" alt="">
				</div>
				<div class="aui-flex-box">
					<p>常见问题</p>
				</div>
			...
			<a href="javascript:;" class="aui-flex b-line">
				<div class="aui-cou-img">
					<img src="../assets/imgs/icon-003.png" alt="">
				</div>
				<div class="aui-flex-box">
					<p>联系客服</p>
				</div>
			...
			<a href="javascript:;" class="aui-flex b-line">
				<div class="aui-cou-img">
					<img src="../assets/imgs/icon-004.png" alt="">
				</div>
				<div class="aui-flex-box">
					<p>关于我们</p>
				</div>
            ...
            <div class="divHeight b-line"></div>
            <a href="javascript:;" class="aui-flex b-line" @click="logOut">
